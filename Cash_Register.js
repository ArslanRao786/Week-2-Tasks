function checkCashRegister(price, cash, cid) {
    ...
    console.log(change);
    const totalCid = cid.reduce((acc, curr) => { return acc + curr[1]; }, 0.0);
    ...
    return clientCashReturn.length < 1 || change > 0 ? { status: "INSUFFICIENT_FUNDS", change: [] } : { status: "OPEN", change: clientCashReturn }
};
